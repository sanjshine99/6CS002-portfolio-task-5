...
/******************************************************************************
 * This class demonstrates sorting a list of movies using both Comparator in
 * the Movie class and a lambda expression. It showcases different ways to
 * achieve sorting based on specific criteria.
 ******************************************************************************/
...
public class Movie5 {
    public static void main(String[] args) {
        ...
        System.out.println("Sorted by Comparator in Movie class");
        movies.stream().sorted().forEach(System.out::println);

        System.out.println();
        System.out.println("Sorted by lambda (Points Against)");
        movies.stream()
                .sorted((m1, m2) -> ((Double) m1.getGross()).compareTo(m2.getGross()))
