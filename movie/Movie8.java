 ...
 * of movies, specifically calculating the total budget of all movies using
...
public class Movie8 {
    public static void main(String[] args) {
        ...
        // Example: Calculate total budget of all movies
        double totalBudget = movies.stream()
                .mapToDouble(Movie::getBudget)
                .reduce(0.0, Double::sum);

        // Format the totalBudget for better readability
        String formattedTotalBudget = String.format("%.2f", totalBudget);

        System.out.println("Total budget: $" + formattedTotalBudget);
