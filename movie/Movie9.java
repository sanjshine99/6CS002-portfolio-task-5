...
/******************************************************************************
 * Example: Grouping movies by rating using functional programming
 * The moviesByRating map stores movies grouped by their rating, where the
 * key is the rating (e.g., "R", "PG") and the value is a list of movies with
 * that rating. This demonstrates the use of Java streams and lambda expressions
 * to achieve concise and expressive code for grouping and printing movies.
 ******************************************************************************/
...
public class Movie9 {
    public static void main(String[] args) {
        ...
        // Example: Group movies by rating
        Map<String, List<Movie>> moviesByRating = movies.stream()
                .collect(Collectors.groupingBy(Movie::getRating));

        // Print movies grouped by rating
        moviesByRating.forEach((rating, movieList) -> {
