...
/******************************************************************************
 * Example: Find the prolific director
 ******************************************************************************/
...
public class Movie12 {
    public static void main(String[] args) {
        ...
        String mostProlificDirector = directorMovieCount.entrySet().stream()
                .max(Map.Entry.comparingByValue())
                .map(Map.Entry::getKey)
                .orElse("Unknown");
        System.out.println("Most Prolific Director: " + mostProlificDirector);
