...
/******************************************************************************
 * Example: Find Highest Grossing Movie
 ******************************************************************************/
...
public class Movie11 {
    public static void main(String[] args) {
        ...
        Optional<Movie> highestGrossingMovie = movies.stream()
                .max(Comparator.comparingDouble(Movie::getGross));
        highestGrossingMovie.ifPresent(movie -> System.out.println("Highest Grossing Movie: " + movie.getName()));
