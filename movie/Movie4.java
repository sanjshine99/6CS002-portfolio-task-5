...
/******************************************************************************
 * This program demonstrates filtering movies based on certain criteria using
 * Java streams. It utilizes the Movie class to represent movie details and
 * applies filters to display specific sets of movies. The code includes
 * examples of filtering movies by their scores.
 ******************************************************************************/
...
public class Movie4 {
    public static void main(String[] args) {
        ...
        System.out.println("Movies with a score of 8.4");
        movies.stream().filter(movie -> movie.getScore() == 8.4)
                .forEach(System.out::println);

        System.out.println();
        System.out.println("Movies with a score of 5.8");
        movies.stream().filter(movie -> movie.getScore() == 5.8)
                .forEach(System.out::println);
    }
}
