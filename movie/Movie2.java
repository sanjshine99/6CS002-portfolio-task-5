...
/******************************************************************************
 * This class demonstrates processing a list of movies with both sequential and
 * parallel streams.
 ******************************************************************************/
...
public class Movie2 {
    public static void main(String[] args) {
        ...
        // Process movies using sequential stream
        System.out.println("Sequential Stream:");
        movies.stream().forEach(System.out::println);
        System.out.println();

        // Process movies using parallel stream
