...
/******************************************************************************
 * This class demonstrates the use of functional programming to filter movies
 * based on a specific genre. The movie dataset is processed using Java streams
 * and lambda expressions to create a list of action movies.
 ******************************************************************************/
...
public class Movie6 {
    public static void main(String[] args) {
        ...
        actionMovies.forEach(movie -> System.out.println(movie.getName()));
    }
}
